                ...
                <div className="flex flex-col w-56 border-r border-gray-300">
                    <button className="relative text-sm focus:outline-none group">
                        ...
                        <div className="absolute z-10 flex-col items-start hidden w-full pb-1 bg-white shadow-lg group-focus:flex">
                            <a className="w-full px-4 py-2 text-left hover:bg-gray-300" href="#">Xem thông tin</a>
                            <a className="w-full px-4 py-2 text-left hover:bg-gray-300" href="#">Đổi Mật khẩu</a>
                        </div>
                    </button>
                    <div className="flex flex-col flex-grow p-4 overflow-auto">
                        <a className="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300 bg-gray-300" href="#">
                            <span className="leading-none">Đăng bài</span>
                        </a>
                        <a className="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
                            <span className="leading-none">Xóa bài</span>
                        </a>
                        <a className="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
                            <span className="leading-none">Đăng giá xe</span>
                        </a>
                        <a className="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
                            <span className="leading-none">Xóa giá xe</span>
                        </a>
                        <a className="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
                            <span className="leading-none">Quản trị viên</span>
                        </a>
                        ...
                        <a className="flex items-center flex-shrink-0 h-10 px-3 mt-auto text-sm font-medium bg-gray-200 rounded hover:bg-gray-300" href="#">
                            ...
                            <span className="ml-2 leading-none">Thêm mới</span>
                        </a>
                    </div>
                </div>
                    ...
                    <div className="flex items-center flex-shrink-0 h-16 px-8 border-b border-gray-300">
                        ...
                        <button className="relative ml-2 text-sm focus:outline-none group">
                            ...
                            <div className="absolute right-0 flex-col items-start hidden w-40 pb-1 bg-white border border-gray-300 shadow-lg group-focus:flex">
                                <a className="w-full px-4 py-2 text-left hover:bg-gray-300" href="#">Đổi mật khẩu</a>
                                <a className="w-full px-4 py-2 text-left hover:bg-gray-300" href="#">Xem thông tin website </a>
                            </div>
                        </button>
                    </div>
                    <div className="flex-grow p-6 overflow-auto bg-gray-200">
                        <div className="grid grid-cols-4 gap-6">
                            <form action="" className='text-slate-950 leading-7 gap-4 grid grid-cols-2 col-span-2 col-start-2 shadow-lg rounded-lg p-4'>
                                <div className="col-span-2 ">
                                    <h3 className='px-2 font-medium'> Tiêu đề </h3>
                                    <input type="text" placeholder="Tiêu đề" className='px-4 py-2 w-full border rounded-md' />
                                </div>
                                <div className="col-span-2 ">
                                    <h3 className='px-2 font-medium'> Tóm tắt </h3>
                                    <input type="text" placeholder="Tóm tắt" className='px-4 py-2 w-full border rounded-md' />
                                </div>
                                <div className="col-span-2">
                                    <h3 className='px-2 font-medium'> Nội dung </h3>
                                    <textarea name="message" rows={5} placeholder="Nội dung chính" className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700" defaultValue={""} />
                                </div>
                                <div className="col-span-2 ">
                                    <h3 className='px-2 font-medium'> Nội dung phụ </h3>
                                    <input type="text" placeholder="Nội dung phụ " className='px-4 py-2 w-full border rounded-md' />
                                </div>
                                <button className='col-span-1 p-4 rounded-xl bg-cyan-500 text-slate-100 font-semibold'> Đăng bài </button>
                                <button className='col-span-1 p-4 rounded-xl bg-cyan-500 text-slate-100 font-semibold'> Xem Demo </button>
                            </form>
